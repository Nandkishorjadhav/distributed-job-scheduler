...
const ENDPOINTS = [
  ...
  },
  {
    ...
    auth: true,
    body: JSON.stringify(
      { name: 'send-email', type: 'immediate', payload: { to: 'user@example.com' } },
      null,
      2
    ),
  ...
  return (
    <div className="max-w-5xl mx-auto space-y-4">
      ...
      <p className="text-sm text-gray-400">
        Click an endpoint, optionally edit the body, then hit <strong>Send</strong>.
      </p>
        ...
        <div className="space-y-3">
          ...
          <div className="bg-gray-900 border border-gray-800 rounded-lg p-4">
            <div className="flex items-center gap-3 mb-1">
              <span
                className={`text-sm font-bold px-2 py-1 rounded border ${methodColor(selected.method)}`}
              >
                {selected.method}
              </span>
          ...
          {(response || status !== null) && (
            <div className="bg-gray-900 border border-gray-800 rounded-lg p-4">
              <div className="flex items-center gap-3 mb-3">
                ...
                {elapsed !== null && <span className="text-xs text-gray-500">{elapsed} ms</span>}
              </div>
